            ...
            <div class="box-body">
              <div class="box-group" id="accordion">
                ...
                <div class="panel box box-danger">
                  <div class="box-header with-border">
                    <h4 class="box-title col-xs-12 col-lg-12 col-md-12">
                      <a aria-expanded="true" class="" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo e($h->id); ?>">
                        Fecha: <?php echo date('d/m/Y H:i',strtotime($h->fechaactualizado)); ?> - Area: <?php echo config('constants.areas.'.$h->areaactual); ?> - OT: <?php echo $h->ot; ?>                      
                      </a>
                      <div class="pull-right info">
                            <i class="fa fa-user"></i>  <?php echo e($h->usuario->name); ?>
                  ...
                  <div style="" aria-expanded="true" id="collapse<?php echo e($h->id); ?>" class="panel-collapse collapse in">
