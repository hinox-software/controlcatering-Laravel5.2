            ...
            <div class="box-body">
              <div class="box-group" id="accordion">
                ...
                <div class="panel box box-danger">
                  <div class="box-header with-border">
                    <h4 class="box-title col-lg-12 col-md-12">
                      <a aria-expanded="false" class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse{{ $h->id}}">
                        Fecha: {!! date('d/m/Y H:i',strtotime($h->fechaactualizado)) !!} - Area: {!! config('constants.areas.'.$h->areaactual) !!} - OT: {!! $h->ot !!}                      
                      </a>
                      <div class="pull-right info">
                            <i class="fa fa-user"></i>  {{ $h->usuario->name}}
                  ...
                  <div style="height: 0px;" aria-expanded="true" id="collapse{{ $h->id}}" class="panel-collapse collapse">
                    <div class="box-body">
                      <div class="row">
                            <div class="col-lg-3 col-md-3">  
                                <dl >
