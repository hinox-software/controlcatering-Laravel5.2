                         ...
                         <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>P-Geo</dt>
                                    <dd>
                                        <?php echo Form::text('posgeo',$tra->posgeo, ['id'=> 'posgeo','class'=>'form-control pullright']); ?>
                            ...
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Tecnico</dt>
                                    <dd>
                                         <?php echo Form::select('tecnico_id', $tecnicos,$tra->tecnicoasig, ['class' => 'form-control pullright', 'readonly', 'disabled']); ?>
                            ...
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Horario</dt>
                                    <dd>
                                        <?php echo Form::select('horario_id', Config::get('constants.horarios'),$tra->horario, ['class' => 'form-control pullright', 'readonly', 'disabled']); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Estado</dt>
                                    <dd> 
                                        <?php echo Form::select('estado_id', Config::get('constants.estadoDigitacion'),null, ['class' => 'form-control pullright', 'id'=> 'estado_id']); ?>
                            ...
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Motivo</dt>
                                    <dd>
                                        <?php echo Form::select('motivo_id', Config::get('constants.motivoDigitacion.TERMINADO'),null, ['class' => 'form-control pullright', 'id'=> 'motivo_id']); ?>
