                            ...
                            <li class="user-footer">
                                ...
                                <div class="row">
                                    ...
                                    <!-- search form (Optional) -->
                                        ...
                                        <?php echo Form::open(['route'=>'api.setdpto','method'=>'POST']); ?>

                                        <div class="input-group">
                                            <?php echo Form::select('dptosession', Config::get('constants.dpto'),Session::get('dptoseleccionado'), ['class' => 'form-control pullright', 'id'=>'dptosession']); ?>
