                         ...
                         <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>P-Geo</dt>
                                    <dd>
                                        {!!Form::text('posgeo',$tra->posgeo, ['id'=> 'posgeo','class'=>'form-control pullright', 'readonly'])!!}
                                    </dd>                                       
                                </dl>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Tecnico</dt>
                                    <dd>
                                         {!! Form::select('tecnico_id', $tecnicos,null, ['class' => 'form-control pullright', 'readonly', 'disabled']) !!}
                                    </dd>                                        
                                </dl>
                            </div>
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Horario</dt>
                                    <dd>
                                         {!! Form::select('horario_id', Config::get('constants.horarios'),$tra->horario, ['class' => 'form-control pullright']) !!}
                                    </dd>                                        
                                </dl>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Estado</dt>
                                    <dd> 
                                        {!! Form::select('estado_id', Config::get('constants.estadoCoordinacion'),null, ['class' => 'form-control pullright', 'id'=> 'estado_id']) !!}
                                    </dd>                                        
                                </dl>
                            </div>
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Motivo</dt>
                                    <dd>
                                        {!! Form::select('motivo_id', Config::get('constants.motivo.ATENDIDO'),null, ['class' => 'form-control pullright', 'id'=> 'motivo_id']) !!}
                                    </dd>                                        
                                </dl>
                            </div>
