                         ...
                         <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Tecnico</dt>
                                    <dd>
                                         {!! Form::select('tecnico_id', $tecnicos, $tra->tecnicoasig, ['class' => 'form-control pullright']) !!}
                                    </dd>                                        
                                </dl>
                            </div>
                            <div class="col-lg-3 col-md-3">  
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Estado</dt>
                                    <dd> 
                                        {!! Form::select('estado_id', Config::get('constants.estadoCentralizacion'),null, ['class' => 'form-control pullright', 'id'=> 'estado_id']) !!}
                                    </dd>                                        
                                </dl>
                            </div>
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Motivo</dt>
                                    <dd>
                                        {!! Form::select('motivo_id', Config::get('constants.motivoCentralizacion.ASIGNADO'),null, ['class' => 'form-control pullright', 'id'=> 'motivo_id']) !!}
                                    </dd>                                        
                                </dl>
                            </div>
