                         ...
                         <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Tecnico</dt>
                                    <dd>
                                         <?php echo Form::select('tecnico_id', $tecnicos, $tra->tecnicoasig, ['class' => 'form-control pullright']); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Estado</dt>
                                    <dd> 
                                        <?php echo Form::select('estado_id', Config::get('constants.estadoCentralizacion'),null, ['class' => 'form-control pullright', 'id'=> 'estado_id']); ?>
                            ...
                            <div class="col-lg-3 col-md-3">  
                                <dl >
                                    <dt>Motivo</dt>
                                    <dd>
                                        <?php echo Form::select('motivo_id', Config::get('constants.motivoCentralizacion.ASIGNADO'),null, ['class' => 'form-control pullright', 'id'=> 'motivo_id']); ?>
